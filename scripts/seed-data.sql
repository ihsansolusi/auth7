...
VALUES
    ...
    ('00000000-0000-0000-0000-000000000902', 'bos7-workflow',        '00000000-0000-0000-0000-000000000001', 'BOS7 Workflow',        'Workflow & BPM management UI',            'web', 'client_secret_basic', '{openid,profile,email,roles}', '{http://localhost:3002/api/auth/callback,https://workflow.bos7.local/api/auth/callback,https://workflow.dev.ihsansolusi.co.id/api/auth/callback,https://bos7-workflow.up.railway.app/api/auth/callback}', true, 'https://bos7-workflow.up.railway.app', 'FlowStream',         '#8a3ffc', '2c7f4589b2fbbe3c0d3ba36bb91d6c17552be7e2374d9dd7363aff54fbe3ea83'),
    ...
    ('00000000-0000-0000-0000-000000000905', 'workflow7',            '00000000-0000-0000-0000-000000000001', 'Workflow7 Service',    'M2M service client for workflow7',        'machine', 'client_secret_basic', '{openid,profile}',              '{}', true, NULL, NULL, NULL, 'b80ca05acda3816c4f98983882fdd1bb710f9812b3d82ada7923760eef65c808'),
...
-- user_branch_assignments: controls branch list in profile panel (separate from user_roles)
INSERT INTO user_branch_assignments (user_id, branch_id, is_primary)
VALUES
    ('00000000-0000-0000-0001-000000000001', '00000000-0000-0000-0000-000000000201', true),
    ('00000000-0000-0000-0001-000000000002', '00000000-0000-0000-0000-000000000201', true),
    ('00000000-0000-0000-0001-000000000003', '00000000-0000-0000-0000-000000000201', true),
    ('00000000-0000-0000-0001-000000000003', '00000000-0000-0000-0000-000000000202', false)
