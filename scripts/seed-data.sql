...
VALUES
    ...
    ('00000000-0000-0000-0000-000000000909', 'bos7-enterprise',      '00000000-0000-0000-0000-000000000001', 'BOS7 Enterprise',      'Enterprise management module',            'web', 'client_secret_basic', '{openid,profile,email,roles}', '{http://localhost:3003/api/auth/callback,https://enterprise.bos7.local/api/auth/callback,https://enterprise.dev.ihsansolusi.co.id/api/auth/callback}', true, 'https://enterprise.bos7.local',     'Enterprise',         '#0f62fe', 'b29557b642e1c7dc5b172e48079842ec2663fc4fa8dcdbb1c4c47acb0b5e9b69'),
    ('00000000-0000-0000-0000-000000000910', 'bos7-financing',       '00000000-0000-0000-0000-000000000001', 'BOS7 Financing',       'Financing (pembiayaan) module',           'web', 'client_secret_basic', '{openid,profile,email,roles}', '{http://localhost:3010/api/auth/callback,https://financing.bos7.local/api/auth/callback,https://financing.dev.ihsansolusi.co.id/api/auth/callback}', true, 'https://financing.bos7.local',      'Finance',            '#198038', '6ec50d1810fa34e0860ae969e49027fd7dd71b8619a2b6904efec3287e802c42'),
    ('00000000-0000-0000-0000-000000000911', 'bos7-funding',         '00000000-0000-0000-0000-000000000001', 'BOS7 Funding',         'Funding (pendanaan) module',              'web', 'client_secret_basic', '{openid,profile,email,roles}', '{http://localhost:3011/api/auth/callback,https://funding.bos7.local/api/auth/callback,https://funding.dev.ihsansolusi.co.id/api/auth/callback}', true, 'https://funding.bos7.local',        'Money',              '#198038', '9b32cbf62ec99dfd155bd1fc16f0778118954793e792982c33bfa3d8210a0eca'),
    ('00000000-0000-0000-0000-000000000912', 'bos7-treasury',        '00000000-0000-0000-0000-000000000001', 'BOS7 Treasury',        'Treasury management module',              'web', 'client_secret_basic', '{openid,profile,email,roles}', '{http://localhost:3012/api/auth/callback,https://treasury.bos7.local/api/auth/callback,https://treasury.dev.ihsansolusi.co.id/api/auth/callback}', true, 'https://treasury.bos7.local',       'Currency',           '#6929c4', 'f70fc402e06c014c155e2a0f1d3e5e0c926fa0f774c7d4595053e7b505770475'),
    ('00000000-0000-0000-0000-000000000913', 'bos7-smt',             '00000000-0000-0000-0000-000000000001', 'BOS7 SMT',             'SMT module',                              'web', 'client_secret_basic', '{openid,profile,email,roles}', '{http://localhost:3013/api/auth/callback,https://smt.bos7.local/api/auth/callback,https://smt.dev.ihsansolusi.co.id/api/auth/callback}', true, 'https://smt.bos7.local',            'Migrate',            '#005d5d', 'a5f26ffd1bd9142cc10b7ced05f71b419f30ad3fd0d9b88ad3465c3565f40d80'),
    ...
    ('00000000-0000-0000-0000-000000000915', 'bos7-cif',             '00000000-0000-0000-0000-000000000001', 'BOS7 CIF',             'Customer Information File module',        'web', 'client_secret_basic', '{openid,profile,email,roles}', '{http://localhost:3015/api/auth/callback,https://cif.bos7.local/api/auth/callback,https://cif.dev.ihsansolusi.co.id/api/auth/callback}', true, 'https://cif.bos7.local',            'UserIdentification', '#0f62fe', '3efee451e84c6c0ffa08f69401606b198ab77fffac8e87d34f6ad625a8fe5f9a'),
    ('00000000-0000-0000-0000-000000000916', 'bos7-internalaccount', '00000000-0000-0000-0000-000000000001', 'BOS7 InternalAccount', 'Internal account management module',     'web', 'client_secret_basic', '{openid,profile,email,roles}', '{http://localhost:3016/api/auth/callback,https://internalaccount.bos7.local/api/auth/callback,https://internalaccount.dev.ihsansolusi.co.id/api/auth/callback}', true, 'https://internalaccount.bos7.local','Account',            '#9f1853', '7fe52794124cd18ec6edf01f9efeb06bffcf12b5f82652035da64ae16f511a52'),
    ('00000000-0000-0000-0000-000000000917', 'bos7-remittance',      '00000000-0000-0000-0000-000000000001', 'BOS7 Remittance',      'Remittance module',                       'web', 'client_secret_basic', '{openid,profile,email,roles}', '{http://localhost:3017/api/auth/callback,https://remittance.bos7.local/api/auth/callback,https://remittance.dev.ihsansolusi.co.id/api/auth/callback}', true, 'https://remittance.bos7.local',     'Send',               '#b28600', 'ce01e0bf98e5f982fd90a68171612594df71862b13744b290e1aee9485a7fa57'),
    ('00000000-0000-0000-0000-000000000918', 'bos7-batchprocessing', '00000000-0000-0000-0000-000000000001', 'BOS7 BatchProcessing', 'Batch processing module',                 'web', 'client_secret_basic', '{openid,profile,email,roles}', '{http://localhost:3018/api/auth/callback,https://batchprocessing.bos7.local/api/auth/callback,https://batchprocessing.dev.ihsansolusi.co.id/api/auth/callback}', true, 'https://batchprocessing.bos7.local','BatchJob',           '#4d5358', '6c367d186687cf37c5ded38dcc83655a98b600084260c5464e487de4a12c4d53'),
    -- Mobile client
